...
{
       0,     0,     3,     5,     8,     9,    16,    21,    24,    25,
      26,    27,    40,    42,    43,    47,    49,    52,    56,    59,
      62,    63,    67,    69,    74,    77,    81,    84,    85,    89,
      91,    95,    99,   101,   103
};
...
{
      17,     0,    -1,    18,    -1,    18,    17,    -1,    -1,     4,
       3,    19,     8,    20,     9,    -1,    20,     7,    34,    32,
      -1,    20,    21,    -1,    -1,    -1,    -1,     7,    34,     5,
       3,    22,    10,    24,    11,    23,     8,    27,     9,    -1,
      25,    -1,    -1,    25,    12,    26,    -1,    26,    -1,     5,
       3,    -1,    28,    13,    27,    -1,    32,    27,    -1,     1,
      27,    -1,    -1,    29,    14,    28,    -1,    29,    -1,    29,
      15,     3,    30,    -1,     3,    30,    -1,    10,    31,    11,
      -1,    10,    11,    -1,    -1,    31,    12,    29,    -1,    29,
      -1,     5,    33,    13,    -1,    33,    12,     3,    -1,     3,
      -1,     6,    -1,    -1
};
...
{
  "$end", "error", "$undefined", "ID", "CLASS", "DATATYPE", "STATIC",
  "AS", "'{'", "'}'", "'('", "')'", "','", "';'", "'='", "'.'", "$accept",
  "P", "CLS", "$@1", "CBLOCK", "FUNC", "$@2", "$@3", "ARGORNULL",
  "ARGLIST", "ARG", "STATEMENTS", "E", "IDI", "FCALLARGS", "CALLARGLIST",
  "DECL", "IDLIST", "STATICORNULL", 0
};
#endif
...
{
       0,     0,     0,     2,     4,     1,     3,     0,     8,     0,
      34,     5,     7,    33,     0,     0,     6,    32,     0,     0,
       0,    30,    13,    31,     0,     0,    12,    15,    16,    10,
       0,     0,    14,     0,     0,    27,     0,     0,     0,    22,
       0,    19,     0,    24,    32,    11,     0,     0,     0,    18,
      26,    29,     0,    17,    21,    27,    25,     0,    23,    28
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     7,     9,    12,    19,    31,    25,    26,
      27,    37,    38,    39,    43,    52,    40,    18,    14
};
...
{
      16,    18,    22,    16,   -43,   -43,   -43,    -3,   -43,     5,
      17,   -43,   -43,   -43,    19,    23,   -43,    15,    -4,    20,
      24,   -43,    26,   -43,    25,    21,    27,   -43,   -43,   -43,
      26,    28,   -43,     1,     1,    30,    31,    29,    32,     2,
       1,   -43,     0,   -43,   -43,   -43,     1,    34,    38,   -43,
     -43,    14,     7,   -43,   -43,    30,   -43,    34,   -43,    14
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -43,    39,   -43,   -43,   -43,   -43,   -43,   -43,   -43,   -43,
       3,   -33,   -12,   -42,   -11,   -43,    33,   -43,   -43
};
...
{
      51,    41,    34,    35,    35,     8,    36,    49,    20,    21,
     -20,    50,    10,    53,    11,    59,    47,    48,    56,    57,
       1,     4,     5,    13,    15,    -9,    17,    23,    28,    48,
      22,    24,    29,    32,    44,    54,    33,    35,    45,    30,
      42,    55,     6,     0,    58,    46,     0,    16
};

static const yytype_int8 yycheck[] =
{
      42,    34,     1,     3,     3,     8,     5,    40,    12,    13,
       9,    11,     7,    46,     9,    57,    14,    15,    11,    12,
       4,     3,     0,     6,     5,    10,     3,     3,     3,    15,
      10,     5,    11,    30,     3,    47,     8,     3,     9,    12,
      10,     3,     3,    -1,    55,    13,    -1,    14
};
...
{
       0,     4,    17,    18,     3,     0,    17,    19,     8,    20,
       7,     9,    21,     6,    34,     5,    32,     3,    33,    22,
      12,    13,    10,     3,     5,    24,    25,    26,     3,    11,
      12,    23,    26,     8,     1,     3,     5,    27,    28,    29,
      32,    27,    10,    30,     3,     9,    13,    14,    15,    27,
      11,    29,    31,    27,    28,     3,    11,    12,    30,    29
};
...
#line 93 "codeGenerator.y"
    {
                                         ...
                                         {
                                             symtab = add( symtab, (yyvsp[(2) - (2)].name), getNextBlockID() );
                                             symtab->type = (yyvsp[(1) - (2)].symp);
...
#line 149 "codeGenerator.y"
    {
                                        ...
                                        (yyval.codeFrag) = (yyvsp[(2) - (3)].codeFrag);
                                    }
    break;
...
#line 175 "codeGenerator.y"
    { 
                            ...
                            {
                                symtab = add( symtab, (yyvsp[(3) - (3)].name), getCurBlockID() );
                                symtab->type = (yyvsp[(0) - (3)].symp);
...
#line 199 "codeGenerator.y"
    {  
                            ...
                            {
                                symtab = add( symtab, (yyvsp[(1) - (1)].name), getCurBlockID() );
                                symtab->type = (yyvsp[(0) - (1)].symp);
                                if( curClassScope == getCurBlockID() )
                                {
                                    symtab->classPtr = curClass;
                                    symtab->as = lastAS;//assign lastAS
